...
<div class="rent_menu">
	...
	<div class="car_type">
		...
		<ul>
			...
			<li><input class="btn-check" checked="checked" type="checkbox"
				name="carType" id="carType3" value="준중형" /> <label
				class="btn btn-outline-dark" for="carType3">준중형</label></li>
			<li><input class="btn-check" checked="checked" type="checkbox"
				name="carType" id="carType4" value="중형" /> <label
				class="btn btn-outline-dark" for="carType4">중형</label></li>
			<li><input class="btn-check" type="checkbox" name="carType"
			...
			<li><input class="btn-check" type="checkbox" name="carType"
				id="carType7" value="전기차" /> <label class="btn btn-outline-dark"
				for="carType7">전기차</label></li>
		</ul>
	</div>
	<div class="car_fuel">
		<div>연료</div>
		<ul>
			<li><input class="btn-check" checked="checked" type="checkbox"
				name="carFure" id="carFure1" value="휘발유"> <label
				class="btn btn-outline-dark" for="carFure1">휘발유</label></li>
			<li><input class="btn-check" type="checkbox" name="carFure"
				id="carFure2" value="경유"> <label
				class="btn btn-outline-dark" for="carFure2">경유</label></li>
			<li><input class="btn-check" type="checkbox" name="carFure"
				id="carFure3" value="하이브리드"> <label
				class="btn btn-outline-dark" for="carFure3">하이브리드</label></li>
			<li><input class="btn-check" type="checkbox" name="carFure"
				id="carFure4" value="전기"> <label
				class="btn btn-outline-dark" for="carFure4">전기</label></li>
		</ul>
	</div>
