...
<script src="${pageContext.request.contextPath }/resources/js/adm_car_list.js"></script>
<link rel="stylesheet" href="${pageContext.request.contextPath }/resources/css/adm_car_list.css">
<style>
