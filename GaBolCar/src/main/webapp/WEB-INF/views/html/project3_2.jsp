...
<head>
	...
	<link href="${pageContext.request.contextPath }/resources/css/project3_2.css" rel="stylesheet">
</head>
<body>
	<header>
	...
	<section id="sec_con" class="inr car_view">
		<div class="upperContainner">
			<div class="slide_wrap">
				<div class="slide_container">
					<div class="mySlides">
						...
						<img src="${pageContext.request.contextPath }/resources/img/코나1.jpg">
					</div>

					<div class="mySlides">
						<div class="numbertext">2&nbsp;&nbsp;/&nbsp;&nbsp;5</div>
						<img src="${pageContext.request.contextPath }/resources/img/코나2.jpg">
					</div>

					<div class="mySlides">
						<div class="numbertext">3&nbsp;&nbsp;/&nbsp;&nbsp;5</div>
						<img src="${pageContext.request.contextPath }/resources/img/코나3.jpg">
					</div>

					<div class="mySlides">
						<div class="numbertext">4&nbsp;&nbsp;/&nbsp;&nbsp;5</div>
						<img src="${pageContext.request.contextPath }/resources/img/코나4.jpg"">
					</div>

					<div class="mySlides">
						<div class="numbertext">5&nbsp;&nbsp;/&nbsp;&nbsp;5</div>
						<img src="${pageContext.request.contextPath }/resources/img/코나5.jpg">
					</div>
				...
				<div class="row">
					<div class="column">
						<img class="demo cursor" src="${pageContext.request.contextPath }/resources/img/코나1.jpg"
							onclick="currentSlide(1)">
					</div>
					<div class="column">
						<img class="demo cursor" src="${pageContext.request.contextPath }/resources/img/코나2.jpg"
							onclick="currentSlide(2)">
					</div>
					<div class="column">
						<img class="demo cursor" src="${pageContext.request.contextPath }/resources/img/코나3.jpg"
							onclick="currentSlide(3)">
					</div>
					<div class="column">
						<img class="demo cursor" src="${pageContext.request.contextPath }/resources/img/코나4.jpg"
							onclick="currentSlide(4)">
					</div>
					<div class="column">
						<img class="demo cursor" src="${pageContext.request.contextPath }/resources/img/코나5.jpg"
			...
			<div class="view_info">
				<div class="view_cont">
					...
					<a href="resInfo" class="view_res_btn">예약하러 가기</a>
				</div>
			</div>
		</div>
		...
		<div class="option_wrap more_wrap_box">
			...
			<div class="more_cont">
				<div class="opt_list">
					<div>
						<img alt="" src="${pageContext.request.contextPath }/resources/img/car.png">
						<p>국제운전면허증가능</p>
					</div>
					<div>
						<img alt="" src="${pageContext.request.contextPath }/resources/img/car.png">
