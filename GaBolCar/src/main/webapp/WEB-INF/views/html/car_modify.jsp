...
<link href="${pageContext.request.contextPath }/resources/css/inc/footer.css" rel="stylesheet">
	...
	<link href="${pageContext.request.contextPath }/resources/css/car_modify.css" rel="stylesheet">
</head>
<body>
	<header>
  ...
  <div id="modifyForm">
    <table>
      ...
      <tr>
        ...
        <td class="td_right">${car.car_image_file } </td>
      </tr>
    </table>
    <div id="commandCell">
      <input type="submit" value="등록" class="btn btn-warning" style="background-color: rgb(255, 94, 0); color: #FFFFFF;">&nbsp;&nbsp;
