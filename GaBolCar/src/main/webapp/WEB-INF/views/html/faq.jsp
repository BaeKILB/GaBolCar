					...
					<ul>
						...
						<li>
							...
							<div class="answer">
								...
								<span class="a_answer"> 
								   ■ 위드렌터카는 유아용카시트, 주니어용 카시트를 무료로 대여해드리고<br>
						...
						<li>
							...
							<div class="answer">
								...
								<span class="a_answer"> 
									...
									차량대여기준(연령/운전경력)<br><br> ■ 전화연락이 힘든 경우, 카카오톡 친구추가 플러스친구 “부산렌트카 위드렌터카”를
						...
						<li>
							...
							<div class="answer">
								<span class="a_icn">A</span> <span class="a_answer">
									★ (주)위드렌터카는 차량손해면책제도를 자체적으로 운영하고 있습니다 ★ <br><br>■ 차량손해면책제도란? <br>- 임차도중 사고발생시의 수리비와
									휴차보상료에 대한 부담을 최소화 하기 위한 자체적 ■ 운영방안 <br>- 사고발생 시 반드시 위드렌터카로 연락해야 함.
