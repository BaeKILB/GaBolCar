					...
					<div class="find_cont">
						...
						<div class="ul1">
							<ul class="isbox"> 
								<li>
									<div >
										<input type="text" name="id_s_name" id="id_s_name" maxLength="25" size="50" placeholder="이름을 입력하세요"value="" />
									</div>
								</li>
								<li>
									<div>
										<input type="text" name="id_s_phone" id="id_s_phone" value="" maxLength="25" size="50" placeholder="휴대폰번호를 입력하세요" />
									</div>
								</li>
							</ul>
						</div>
