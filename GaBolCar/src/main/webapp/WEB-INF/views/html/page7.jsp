...
<link href="${pageContext.request.contextPath }/resources/css/page7.css" rel="stylesheet">
</head>
	...
	<div id="sec_con" class="inr">
		...
		<div class="rent_proc rent_int_wrap">
			...
			<div class="mt-5">
				<div class="row_i">
					<div class="col-3">
						<img class="card-img-top" src="${pageContext.request.contextPath }/resources/img/building.png">
						<h4 class="my-3">1. 지점방문</h4>
						<p>직원에게 예약번호 또는<br> 예약자 성명을 말씀해주세요.<br> (외국인일 경우 여권 및 국제면허증
						지참)</p>
					</div>
					<div class="col-3">
						<img class="card-img-top" src="${pageContext.request.contextPath }/resources/img/loyalty-card.png">
						<h4 class="my-3">2. 고객 정보 확인</h4>
						<p>예약사항을 확인 후,<br> 차량임대차 계약서 작성을 위해<br> 면허증을 담당직원에게 제시해
						주세요.<br> (모바일 PASS 면허는 불가)</p>
					</div>
					<div class="col-3">
						<img class="card-img-top" src="${pageContext.request.contextPath }/resources/img/customer.png">
						<h4 class="my-3">3. 대여료 결제</h4>
						<p>대여기간 및 차종, 옵션 등<br> 최종 확인한 후<br> 차량 대여료를 결제해주세요.</p>
					</div>
					<div class="col-3">
						<img class="card-img-top" src="${pageContext.request.contextPath }/resources/img/listing.png">
		...
		<div class="ret_proc rent_int_wrap">
			...
			<div class="mt-5">
				<div class="row_i">
					...
					<div class="col-3">
						<img class="card-img-top" src="${pageContext.request.contextPath }/resources/img/key-features.png">
						<h4 class="my-3">2. 자동차 키 반납</h4>
						<p>담당직원에게<br> 차량 Key를 반납하세요.</p>
					</div>
					<div class="col-3">
						<img class="card-img-top" src="${pageContext.request.contextPath }/resources/img/car.png">
