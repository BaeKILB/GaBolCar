...
<link rel="stylesheet" href="${pageContext.request.contextPath }/resources/css/branch.css" >
...
<body>
	...
	<section id="sec_con" class="inr">
		<article class="branch_top">
			...
			<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/branch_location_map.js"></script>
		</article>
